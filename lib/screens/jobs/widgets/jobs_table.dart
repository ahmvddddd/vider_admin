                      ...
                      (index) {
                        ...
                        return DataRow(
                          cells: [
                            ...
                            DataCell(Text(job["_id"].toString(),
                            style: Theme.of(context).textTheme.labelSmall,)),
                            DataCell(CircleAvatar(
                              radius: 10,
                              backgroundColor: Colors.grey,
                              child: Icon(job["profileImage"],
                              color: Colors.white, size: Sizes.iconSm),)),
                            DataCell(Text(job["providerName"].toString(),
                            style: Theme.of(context).textTheme.labelSmall,)),
                            DataCell(Text(job["employerName"].toString(),
                            style: Theme.of(context).textTheme.labelSmall,)),
                            DataCell(Text(job["jobTitle"].toString(),
                            style: Theme.of(context).textTheme.labelSmall,)),
